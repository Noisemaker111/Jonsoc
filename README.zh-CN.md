...
了解更多 [Agents](https://jonsoc.ai/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://jonsoc.ai/docs)。
...
- 100% 开源。
- 不绑定特定提供商。推荐使用 [JonsOC Zen](https://jonsoc.ai/zen) 的模型，但也可搭配 Claude、OpenAI、Google 甚至本地模型。模型迭代会缩小差异、降低成本，因此保持 provider-agnostic 很重要。
- 内置 LSP 支持。
