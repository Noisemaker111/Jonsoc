...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Noisemaker111/JonsOpencode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Noisemaker111/JonsOpencode...\n")
