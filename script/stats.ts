...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Noisemaker111/Jonsoc/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Noisemaker111/Jonsoc...\n")
...
console.log("Fetching npm all-time downloads for jonsoc...\n")
const npmDownloads = await fetchNpmDownloads("jonsoc")
