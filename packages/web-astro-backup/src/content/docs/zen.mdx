---
title: Zen
description: Curated list of models provided by JonsOC.
---
...
JonsOC Zen is a list of tested and verified models provided by the JonsOC team.

:::note
JonsOC Zen is currently in beta.
:::

Zen works like any other provider in JonsOC. You login to JonsOC Zen and get
...
:::tip
We tested a select group of models and providers that work well with JonsOC.
:::
...
JonsOC Zen is an AI gateway that gives you access to these models.

---

## How it works

JonsOC Zen works like any other provider in JonsOC.

1. You sign in to **<a href={console}>JonsOC Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select JonsOC Zen, and paste your API key.
...
| ------------------ | ------------------ | -------------------------------------------------- | --------------------------- |
| GPT 5.2            | gpt-5.2            | `https://jonsoc.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2 Codex      | gpt-5.2-codex      | `https://jonsoc.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1            | gpt-5.1            | `https://jonsoc.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex      | gpt-5.1-codex      | `https://jonsoc.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max  | gpt-5.1-codex-max  | `https://jonsoc.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini | gpt-5.1-codex-mini | `https://jonsoc.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5              | gpt-5              | `https://jonsoc.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Codex        | gpt-5-codex        | `https://jonsoc.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Nano         | gpt-5-nano         | `https://jonsoc.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| Claude Sonnet 4.5  | claude-sonnet-4-5  | `https://jonsoc.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4    | claude-sonnet-4    | `https://jonsoc.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5   | claude-haiku-4-5   | `https://jonsoc.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5   | claude-3-5-haiku   | `https://jonsoc.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.5    | claude-opus-4-5    | `https://jonsoc.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.1    | claude-opus-4-1    | `https://jonsoc.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Gemini 3 Pro       | gemini-3-pro       | `https://jonsoc.com/zen/v1/models/gemini-3-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash     | gemini-3-flash     | `https://jonsoc.com/zen/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| GLM 4.7            | glm-4.7            | `https://jonsoc.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.6            | glm-4.6            | `https://jonsoc.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2            | kimi-k2            | `https://jonsoc.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Thinking   | kimi-k2-thinking   | `https://jonsoc.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3 Coder 480B   | qwen3-coder        | `https://jonsoc.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Grok Code Fast 1   | grok-code          | `https://jonsoc.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Big Pickle         | big-pickle         | `https://jonsoc.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

The [model id](/docs/config/#models) in your JonsOC config
uses the format `jonsoc/<model-id>`. For example, for GPT 5.2 Codex, you would
use `jonsoc/gpt-5.2-codex` in your config.
...
```
https://jonsoc.com/zen/v1/models
```
...
- Grok Code Fast 1 is currently free on JonsOC for a limited time. The xAI team is using this time to collect feedback and improve Grok Code.
- Big Pickle is a stealth model that's free on JonsOC for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with JonsOC as well.
