---
title: Share
description: Share your JonsOC conversations.
---

JonsOC's share feature allows you to create public links to your JonsOC conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, JonsOC:

1. Creates a unique public URL for your session
2. Syncs your conversation history to our servers
3. Makes the conversation accessible via the shareable link — `joc.ai/s/<share-id>`

---

## Sharing

JonsOC supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, JonsOC uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
{
  "$schema": "https://joc.ai/config.json",
  "share": "manual"
}
```
...
To enforce this across your team for a given project, add it to the `jonsoc.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using jonsoc in your organization.
