export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo JonsOC",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no JonsOC.",
  ...
  "provider.connect.jonsocZen.line1":
    "JonsOC Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.jonsocZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.jonsocZen.visit.prefix": "Visite ",
  "provider.connect.jonsocZen.visit.link": "jonsoc.com/zen",
  "provider.connect.jonsocZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no JonsOC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no JonsOC.",
  ...
  "dialog.server.description": "Trocar para qual servidor JonsOC este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do JonsOC ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do JonsOC",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (jonsoc.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: JonsOC ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "JonsOC inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do JonsOC",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o JonsOC aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o JonsOC é tematizado.",
