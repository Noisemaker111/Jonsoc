export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez JonsOC",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w JonsOC.",
  ...
  "provider.connect.jonsocZen.line1":
    "JonsOC Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.jonsocZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.jonsocZen.visit.prefix": "Odwiedź ",
  "provider.connect.jonsocZen.visit.link": "jonsoc.com/zen",
  "provider.connect.jonsocZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w JonsOC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w JonsOC.",
  ...
  "dialog.server.description": "Przełącz serwer JonsOC, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja JonsOC ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu JonsOC",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (jonsoc.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, JonsOC nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "JonsOC zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla JonsOC",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd JonsOC na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw JonsOC.",
