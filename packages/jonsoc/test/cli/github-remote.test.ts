...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/jonsoc.git")).toEqual({ owner: "sst", repo: "jonsoc" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/jonsoc")).toEqual({ owner: "sst", repo: "jonsoc" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/jonsoc.git")).toEqual({ owner: "sst", repo: "jonsoc" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/jonsoc")).toEqual({ owner: "sst", repo: "jonsoc" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/jonsoc.git")).toEqual({ owner: "sst", repo: "jonsoc" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/jonsoc")).toEqual({ owner: "sst", repo: "jonsoc" })
})
