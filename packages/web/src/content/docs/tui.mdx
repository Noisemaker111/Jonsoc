---
title: TUI
description: Using the JonsOC terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

JonsOC provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running JonsOC starts the TUI for the current directory.
...
When using the JonsOC TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to JonsOC. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your JonsOC config file.
