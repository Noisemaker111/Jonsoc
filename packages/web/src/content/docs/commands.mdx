...
Create `.jonsoc/commands/test.md`:

```md title=".jonsoc/commands/test.md"
---
...
You can add custom commands through the JonsOC config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your JonsOC [config](/docs/config):

```json title="jonsoc.jsonc" {4-12}
{
...
- Global: `~/.config/jonsoc/commands/`
- Per-project: `.jonsoc/commands/`

```markdown title="~/.config/jonsoc/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".jonsoc/commands/component.md"
---
...
```md title=".jonsoc/commands/create-file.md"
---
...
```md title=".jonsoc/commands/analyze-coverage.md"
---
...
```md title=".jonsoc/commands/review-changes.md"
---
...
```md title=".jonsoc/commands/review-component.md"
---
...
jonsoc includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
