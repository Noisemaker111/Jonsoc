---
title: LSP Servers
description: JonsOC integrates with your LSP servers.
---

JonsOC integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

JonsOC comes with several built-in LSP servers for popular languages:
...
You can customize LSP servers through the `lsp` section in your jonsoc config.
