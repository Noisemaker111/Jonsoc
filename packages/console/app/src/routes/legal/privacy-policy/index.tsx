...
export default function PrivacyPolicy() {
  return (
    <main data-page="legal">
      <Title>JonsOC | Privacy Policy</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/privacy-policy`} />
      <Meta name="description" content="JonsOC privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At JonsOC, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of JonsOC is at all times subject to our Terms of Use,{" "}
                <a href="/legal/terms-of-service">https://jonsoc.com/legal/terms-of-service</a>, which incorporates
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the JonsOC website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about JonsOC.
                </li>
              ...
              <p>
                ...
                you, JonsOC or another party; enforcing any agreements with you; responding to claims that any posting
