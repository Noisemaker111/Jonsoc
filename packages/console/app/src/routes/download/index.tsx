...
export default function Download() {
  ...
  return (
    <main data-page="download">
      <Title>JonsOC | Download</Title>
      <Link rel="canonical" href={`${config.baseUrl}/download`} />
      <Meta name="description" content="Download JonsOC for macOS, Windows, and Linux" />
        ...
        <div data-component="content">
          <section data-component="download-hero">
            <div data-component="hero-icon">
              <img src={desktopAppIcon} alt="JonsOC Desktop" />
            </div>
            <div data-component="hero-text">
              <h1>Download JonsOC</h1>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[4]</span> JonsOC Integrations
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
          ...
          <ul>
            <li>
              <Faq question="What is JonsOC?">
                JonsOC is an open source agent that helps you write and run code with any AI model. It's available as
            ...
            <li>
              <Faq question="Do I need extra AI subscriptions to use JonsOC?">
                Not necessarily, but probably. You'll need an AI subscription if you want to connect JonsOC to a paid
                provider, although you can work with{" "}
                <a href="/docs/providers/#lm-studio" target="_blank">
                  local models
                </a>{" "}
                for free. While we encourage users to use <A href="/zen">Zen</A>, JonsOC works with all popular
            ...
            <li>
              <Faq question="How much does JonsOC cost?">
                JonsOC is 100% free to use. Any additional costs will come from your subscription to a model provider.
                While JonsOC works with any model provider, we recommend using <A href="/zen">Zen</A>.
              </Faq>
            </li>
            <li>
              <Faq question="What about data and privacy?">
                Your data and information is only stored when you create sharable links in JonsOC. Learn more about{" "}
