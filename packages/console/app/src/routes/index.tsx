        ...
        <div data-component="content">
          ...
          <section data-component="what">
            <div data-slot="section-title">
              <h3>What is JonsOC?</h3>
              <p>JonsOC is an open source agent that helps you write code in your terminal, IDE, or desktop.</p>
            </div>
            <ul>
              <li>
                <span>[*]</span>
            ...
            <div data-slot="section-title">
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>{config.stats.commits}</strong> commits, JonsOC is used and trusted by over{" "}
          ...
          <section data-component="privacy">
            <div data-slot="privacy-title">
              ...
              <div>
                ...
                <p>
                  JonsOC does not store any of your code or context data, so that it can operate in privacy sensitive
          ...
          <section data-component="faq">
            ...
            <ul>
              <li>
                <Faq question="What is JonsOC?">
                  JonsOC is an open source agent that helps you write and run code with any AI model. It's available
                  as a terminal-based interface, desktop app, or IDE extension.
                </Faq>
              </li>
              <li>
                <Faq question="How do I use JonsOC?">
                  The easiest way to get started is to read the <a href="/docs">intro</a>.
                </Faq>
              </li>
              <li>
                <Faq question="Do I need extra AI subscriptions to use JonsOC?">
                  Not necessarily, JonsOC comes with a set of free models that you can use without creating an
                  account. Aside from these, you can use any of the popular coding models by creating a{" "}
                  <A href="/zen">Zen</A> account. While we encourage users to use Zen, JonsOC also works with all
              ...
              <li>
                <Faq question="Can I use my existing AI subscriptions with JonsOC?">
                  Yes, JonsOC supports subscription plans from all major providers. You can use your Claude Pro/Max,
                  ChatGPT Plus/Pro, or GitHub Copilot subscriptions. <a href="/docs/providers/#directory">Learn more</a>
                  .
                </Faq>
              </li>
              <li>
                <Faq question="Can I only use JonsOC in the terminal?">
                  Not anymore! JonsOC is now available as an app for your <a href="/download">desktop</a> and{" "}
                  <a href="/docs/web">web</a>!
                </Faq>
              </li>
              <li>
                <Faq question="How much does JonsOC cost?">
                  JonsOC is 100% free to use. It also comes with a set of free models. There might be additional costs
              ...
              <li>
                <Faq question="Is JonsOC open source?">
                  Yes, JonsOC is fully open source. The source code is public on{" "}
          ...
          <section data-component="zen-cta">
            <div data-slot="zen-cta-copy">
              ...
              <p>
                Zen gives you access to a handpicked set of AI models that JonsOC has tested and benchmarked
