...
console.log("🚀 Starting jonsoc server...")
...
app.message(async ({ message, say }) => {
  ...
  if (!session) {
    console.log("🆕 Creating new jonsoc session...")
    ...
    console.log("✅ Created jonsoc session:", createResult.data.id)
  ...
  console.log("📝 Sending to jonsoc:", message.text)
